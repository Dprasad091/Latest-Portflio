    ...
    content: (
      <div className='space-y-4'>
        <TextEffect per='char' preset='fade' className="text-4xl font-bold">
          Hey! I'm Dumpala Durga Prasad.
        </TextEffect>
        <TextEffect per='char' preset='fade' className="text-2xl">
          I'm a Full Stack Developer, AI/ML Enthusiast. I love building web applications and exploring new technologies.
        </TextEffect>
        <a target='_blank' href='https://drive.google.com/file/d/1nKbfC71PJRU1Kx1ZoHqKDW8s0GztniKj/view?usp=sharing' download className='btn flex items-center gap-4'><MoveRight className='h-5 w-5 mt-1'/><TextEffect className="text-2xl">My Resume</TextEffect></a>
      </div>
    ),
  },
  {
    id: 'Learning Journey & Skill Development',
    label: 'Learning Journey & Skill Development',
    icon: <Boxes className='h-5 w-5' />,
    content: (
      <div>
        <h2 className="text-3xl font-bold mb-6 text-center">Learning Journey & Skill Development</h2>
